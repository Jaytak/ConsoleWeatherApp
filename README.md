...
> [!IMPORTANT]
> You must install the following dependency to run this app!
>
...
`$ python weather.py update-key`<br>
...
`$ python weather.py purge-logs`<br>
...
##### APP RESET MODE:
`$ python weather.py app-reset --CONFIRM-RESET`<br>
